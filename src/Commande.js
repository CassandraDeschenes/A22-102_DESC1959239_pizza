...
const Commande = (listePizza, nomPizza, prix) => {
    ...
    return (
        ...
        >
            <div className="page-content page-panier">
                    <div className="panier">
                        <Header compteItemsPanier={itemsPanier.length} />
                        <div className="row">
                            <fieldset><Main itemsPanier={itemsPanier} produits={produits} listePizza={listePizza} nomPizza={nomPizza} prix={prix} onAdd={onAdd} onRemove={onRemove} /></fieldset>
                            <fieldset><Panier itemsPanier={itemsPanier} onAdd={onAdd} onRemove={onRemove} /></fieldset>
                        </div>
                    </div>
